...
while True:
    ...
    for c in cnts:
        ...
        cv2.line(frame, (int(round(width / 2)), 0), (width, 450), (250, 0, 1), 2) #blue line
        cv2.line(frame, (int(round(width / 2)) - 50, 0), (width - 50, 450), (0, 0, 255), 2)#red line


        rectagleCenterPont = (int(round((x + x + w) /2)),int(round( (y + y + h) /2)))
